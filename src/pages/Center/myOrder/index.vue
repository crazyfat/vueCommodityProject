  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="(order, index) of info.records" :key="order.id">
          <thead>
          <tr>
            <th colspan="5">
          ...
          <tr v-for="(item, index) of order.orderDetailList" :key="item.id">
            <td width="60%">
              <div class="typographic">
                <img style="width: 85px;height: 85px" :src="item.imgUrl">
      ...
      <div class="choose-order">
        <Pagination :page-no="page" :total="info.total" :continues="5" :page-size="10" @getPageNo="getPageNo"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  methods:{
    ...
    getData() {
      this.$API.reqMyOrder(this.page, this.limit).then(
          value => {
            if(value.code==200){
